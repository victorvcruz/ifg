...
- [Escalonamento em Sistemas Multicore](#escalonamento-em-sistemas-multicore)
    ...
    - [Alocação de Processos em Sistemas Multicore](#alocação-de-processos-em-sistemas-multicore)
        - [Escalonamento com Afinidade](#escalonamento-com-afinidade)
        - [Balanceamento de Carga](#balanceamento-de-carga)
        - [Escalonamento Global e Escalonamento Local](#escalonamento-global-e-escalonamento-local)
